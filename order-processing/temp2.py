...
class Orderline(models.Model):
    orderline_ptr_id = models.IntegerField(primary_key=True)
...
class OrdersPickupline(models.Model):
...
class ProductPincodeMapping(models.Model):
    ...
    region = models.ForeignKey('RegionMaster', blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'product_pincode_mapping'
        unique_together = (('store_id', 'base_product_id', 'region_id'),)
