...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'bhaskar.2500@gmail.com'
EMAIL_HOST_PASSWORD = 'fallacious7'
	...
	{'label': 'Manage Order (Live)', 'permissions': 'auth.add_user', 'models': [
            ...
            {'label':'Pickup Line','url':'/admin/Orders/pickupline'},
              {'label':'Delivery Line','url':'/admin/Orders/deliveryline'},
               {'label':'History Line','url':'/admin/Orders/orderline_history'},
            {'label':'CRMLine','url':'/admin/Orders/crm'},
            {'label':'LineStatus','url':'/admin/Orders/linestatus'},    
              {'label':'OrderStatus','url':'/admin/Orders/orderstatus'}
